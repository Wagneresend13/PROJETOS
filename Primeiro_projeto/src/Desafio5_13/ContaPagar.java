...
public class ContaPagar {
	...
	public void pagar() {
		...
		if(situacaoConta.equals(situacaoConta.PAGA)){
			...
			System.out.println(" Não pode pagar uma conta que já esta cancelada");
		}else {
	...
	public void cancelar() {
		...
		if(situacaoConta.equals(situacaoConta.CANCELADA)) {
			System.out.println(" Não se pode cancelar uma conta já com status cancelado");
		}else if(situacaoConta.equals(situacaoConta.PAGA)) {
			System.out.println(" Não se pode cancelar uma conta ja com status PAGA");
		}else {
